...
import 'package:m360_app_central/ui/views/profile/profile_view.dart';
import 'package:m360_app_central/ui/views/test/test_view.dart';
// import 'package:m360_app_central/ui/views/home/home_view.dart';
import 'package:m360_app_corpsec/ui/views/central/central_view.dart';
// @stacked-import
...
@StackedApp(
  routes: [
    ...
    MaterialRoute(page: CentralView),
// @stacked-route
  ],
  dependencies: [
    // LazySingleton(classType: BottomSheetService, instanceName: 'corpsec'),
    // LazySingleton(classType: DialogService, instanceName: 'corpsec'),
    // LazySingleton(classType: NavigationService, instanceName: 'corpsec'),
    // LazySingleton(classType: AuthenticationService, instanceName: 'corpsec'),
    // LazySingleton(classType: ShareService, instanceName: 'corpsec'),
    // LazySingleton(classType: CompanyService, instanceName: 'corpsec'),
    // LazySingleton(classType: TestService, instanceName: 'corpsec'),
