...
class AuthenticationService with ApiServiceMixin {
  ...
  Future<TokenSet> getOidcTokenWithRefreshToken([String clientId = 'central']) async {
    setBusy(true);
  ...
  Future<TokenSet> _loginWithOidcToken(TokenSet tr, [String moduleType = 'corpsec']) async {
    setBusy(true);
    final headers = {
