...
import '../ui/dialogs/calender_date_picker/calender_date_picker_dialog.dart';
...
void setupDialogUi() {
  ...
  final Map<DialogType, DialogBuilder> builders = {
    ...
    DialogType.calenderDatePicker: (context, request, completer) =>
        CalenderDatePickerDialog(request: request, completer: completer),
  };
