...
class wCompanyShareholder extends StatelessWidget {
  ...
  const wCompanyShareholder({super.key, required this.company, bool? isBusy}) : isBusy = (isBusy ?? false);
  ...
  Widget build(BuildContext context) {
    ...
    var l = calculateShareholderPercent(c.shareholders, totalShare: ordinaryTotalShare);
    l = sortLargestShareholder(l, shareTypeId: "ordinary-sgd");
