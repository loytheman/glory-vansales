...
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthenticationService extends _i1.Mock implements _i8.AuthenticationService {
  @override
  ...
  @override
  set openIdConfig(_i8.OpenIdConfig? _openIdConfig) => super.noSuchMethod(
        Invocation.setter(
          #openIdConfig,
          _openIdConfig,
        ),
  ...
  @override
  _i6.Future<_i2.TokenSet?> getLoginViaStore() => (super.noSuchMethod(
        Invocation.method(
          #getLoginViaStore,
          [],
        ),
        returnValue: _i6.Future<_i2.TokenSet?>.value(),
        returnValueForMissingStub: _i6.Future<_i2.TokenSet?>.value(),
      ) as _i6.Future<_i2.TokenSet?>);

  @override
  _i6.Future<void> loginViaOidc() => (super.noSuchMethod(
        Invocation.method(
          #loginViaOidc,
          [],
        ),
  ...
  @override
  _i6.Future<_i2.TokenSet> returnToAuthCodeLoginFlow(String? code) => (super.noSuchMethod(
        Invocation.method(
          #returnToAuthCodeLoginFlow,
          [code],
        ),
        returnValue: _i6.Future<_i2.TokenSet>.value(_FakeTokenSet_0(
          this,
          Invocation.method(
            #returnToAuthCodeLoginFlow,
            [code],
        ...
        returnValueForMissingStub: _i6.Future<_i2.TokenSet>.value(_FakeTokenSet_0(
          this,
          Invocation.method(
            #returnToAuthCodeLoginFlow,
            [code],
  ...
  @override
  _i6.Future<void> loginViaEmail(Map<dynamic, dynamic>? data) => (super.noSuchMethod(
        Invocation.method(
          #loginViaEmail,
          [data],
        ),
  ...
  @override
  _i6.Future<_i2.TokenSet> loginViaRefreshToken() => (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<void> logoutOidc() => (super.noSuchMethod(
        Invocation.method(
          #logoutOidc,
          [],
        ),
  ...
  @override
  _i6.Future<void> registerDeviceToken(String? deviceToken) => (super.noSuchMethod(
        Invocation.method(
          #registerDeviceToken,
          [deviceToken],
        ),
  ...
  @override
  _i6.Future<void> afterLogin(_i2.TokenSet? ts) => (super.noSuchMethod(
        Invocation.method(
          #afterLogin,
          [ts],
        ),
  ...
  @override
  _i6.Future<void> biometricAuthAction({String? reason = ' '}) => (super.noSuchMethod(
        Invocation.method(
          #biometricAuthAction,
          [],
          {#reason: reason},
  ...
  @override
  _i6.Future<void> setUseBiometricAction(bool? value) => (super.noSuchMethod(
        Invocation.method(
...
class MockShareService extends _i1.Mock implements _i9.ShareService {
  @override
  set onFunc(_i7.VoidCallback? _onFunc) => super.noSuchMethod(
        Invocation.setter(
          #onFunc,
          _onFunc,
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCompanyService extends _i1.Mock implements _i10.CompanyService {
  @override
  set currentCompany(_i11.Company? _currentCompany) => super.noSuchMethod(
        Invocation.setter(
          #currentCompany,
          _currentCompany,
        ),
  ...
  @override
  List<_i11.Company> get companyArr => (super.noSuchMethod(
        Invocation.getter(#companyArr),
        returnValue: <_i11.Company>[],
        returnValueForMissingStub: <_i11.Company>[],
      ) as List<_i11.Company>);

  @override
  set companyArr(List<_i11.Company>? _companyArr) => super.noSuchMethod(
        Invocation.setter(
          #companyArr,
          _companyArr,
        ),
  ...
  @override
  _i6.Future<void> setCurrentCompany({
    String? companyId,
  ...
  @override
  _i6.Future<_i11.Company?> getCompany(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getCompany,
          [id],
        ),
        returnValue: _i6.Future<_i11.Company?>.value(),
        returnValueForMissingStub: _i6.Future<_i11.Company?>.value(),
      ) as _i6.Future<_i11.Company?>);

  @override
  _i6.Future<List<_i11.Company>> getAllCompany() => (super.noSuchMethod(
        Invocation.method(
          #getAllCompany,
          [],
        ),
        returnValue: _i6.Future<List<_i11.Company>>.value(<_i11.Company>[]),
        returnValueForMissingStub: _i6.Future<List<_i11.Company>>.value(<_i11.Company>[]),
      ) as _i6.Future<List<_i11.Company>>);

  @override
  _i6.Future<List<_i11.Timeline>> getDashboardTimeline(String? id) => (super.noSuchMethod(
        Invocation.method(
          #getDashboardTimeline,
          [id],
        ),
        returnValue: _i6.Future<List<_i11.Timeline>>.value(<_i11.Timeline>[]),
        returnValueForMissingStub: _i6.Future<List<_i11.Timeline>>.value(<_i11.Timeline>[]),
      ) as _i6.Future<List<_i11.Timeline>>);

  @override
  _i6.Future<List<_i11.Document>> getDocuments(String? companyId) => (super.noSuchMethod(
        Invocation.method(
          #getDocuments,
          [companyId],
        ),
        returnValue: _i6.Future<List<_i11.Document>>.value(<_i11.Document>[]),
        returnValueForMissingStub: _i6.Future<List<_i11.Document>>.value(<_i11.Document>[]),
      ) as _i6.Future<List<_i11.Document>>);
